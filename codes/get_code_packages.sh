...
(cd 3dMCGlauber_code; git checkout 57f25a066bb37cb5b29ac3d912f33fb6a5085ed0)
rm -fr 3dMCGlauber_code/.git

# download IPGlasma
rm -fr ipglasma_code
git clone --depth=1 https://github.com/chunshen1987/ipglasma -b ipglasma_jimwlk ipglasma_code
(cd ipglasma_code; git checkout afbe686b8703d189ee8d2656ceef5dbfbffd707d)
...
(cd MUSIC_code; git checkout febb2ab687dab86a8d2593daad9760560a27376b)

...
(cd MUSIC_code; git checkout 7e8234e988f442330c1f8f8c9982f1fe6fce638a)
...
git clone --depth=3 https://github.com/chunshen1987/hadronic_afterburner_toolkit -b main hadronic_afterburner_toolkit_code

...
for icen in range(len(centralityCutList) - 1):
    ...
    for event_name in selected_events_list:
        QnArr1.append(data[event_name]['ALICE_eta_-0p8_0p8_pT_0p2_4'])
        QnArr2.append(data[event_name]['ALICE_eta_-0p8_-0p5_pT_0p2_4'])
        QnArr3.append(data[event_name]['ALICE_eta_0p5_0p8_pT_0p2_4'])

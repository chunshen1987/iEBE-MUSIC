...
def calculateNonLinearResponseV5_2sub(vn_data_array1, vn_data_array2,
    ...
    chi_523_err = np.sqrt((nev - 1.)/nev
                          * np.sum((np.real(chi_523_JK) - chi_523_mean)**2))
    chi_514_mean = np.mean(np.real(chi_514_JK))
    chi_514_err = np.sqrt((nev - 1.)/nev
                          * np.sum((np.real(chi_514_JK) - chi_514_mean)**2.))
    ...
    chi_523_err = np.sqrt((nev - 1.)/nev
                          * np.sum((np.imag(chi_523_JK) - chi_523_mean)**2))
    chi_514_mean = np.mean(np.imag(chi_514_JK))
    chi_514_err = np.sqrt((nev - 1.)/nev
                          * np.sum((np.imag(chi_514_JK) - chi_514_mean)**2.))
    results += [chi_523_mean, chi_523_err, chi_514_mean, chi_514_err]

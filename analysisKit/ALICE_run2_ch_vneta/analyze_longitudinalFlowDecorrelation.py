...
for icen in range(len(centralityCutList) - 1):
    ...
    calculate_rneta(etaArr, QnArr, [2, 2.4], 2,
                    f"ALICE_r2eta_Ref_2_2p4_C{cenLabel}.txt")
    calculate_rneta(etaArr, QnArr, [2, 2.4], 3,
                    f"ALICE_r3eta_Ref_2_2p4_C{cenLabel}.txt")
    calculate_rneta(etaArr, QnArr, [2.8, 3.2], 2,
                    f"ALICE_r2eta_Ref_2p8_3p2_C{cenLabel}.txt")
    calculate_rneta(etaArr, QnArr, [2.8, 3.2], 3,
                    f"ALICE_r3eta_Ref_2p8_3p2_C{cenLabel}.txt")

...
def calculate_vneta(etaArr, dataArr, dataRef, etaRef, nOrder,
...
for icen in range(len(centralityCutList) - 1):
    ...
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [0.8, 1], 2,
                    f"ALICE_v2eta_0p8_2p6_C{cenLabel}.txt")
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [0.8, 1], 3,
                    f"ALICE_v3eta_0p8_2p6_C{cenLabel}.txt")
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [2, 3.5], 2,
                    f"ALICE_v2eta_2_3p8_C{cenLabel}.txt")
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [2, 3.5], 3,
                    f"ALICE_v3eta_2_3p8_C{cenLabel}.txt")
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [0.2, 1], 2,
                    f"ALICE_v2eta_forward_2_C{cenLabel}.txt")
    calculate_vneta(etaArr, QnArrEta, QnArrEta, [0.2, 1], 3,
                    f"ALICE_v3eta_forward_2_C{cenLabel}.txt")

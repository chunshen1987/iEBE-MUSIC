...
def calculateNonLinearResponseV7_2sub(vn_data_array1, vn_data_array2,
    ...
    chi_7223_err = np.sqrt((nev - 1.)/nev*np.sum(
        (np.real(chi_7223_JK) - chi_7223_mean)**2))
    chi_734_mean = np.mean(np.real(chi_734_JK))
    chi_734_err = np.sqrt((nev - 1.)/nev*np.sum(
        (np.real(chi_734_JK) - chi_734_mean)**2.))
    chi_725_mean = np.mean(np.real(chi_725_JK))
    chi_725_err = np.sqrt((nev - 1.)/nev*np.sum(
        (np.real(chi_725_JK) - chi_725_mean)**2.))
    results = [
        chi_7223_mean, chi_7223_err, chi_734_mean, chi_734_err, chi_725_mean,
        chi_725_err
    ]

...
dNDataCovList.append(computeCovarianceMatrix(dNdata[:dNcenCut, 2]/2.,
                                             dNdata[:dNcenCut, 3]/2.))
...
# 0-5%
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=13, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
                                                   dNchdetaData[:, 6]))

# 5-10%
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=53, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
...
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=93, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
...
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=133, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
...
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=173, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
...
dNchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins1507090-v1-DN_DETARAP.csv"),
    delimiter=',', skiprows=213, max_rows=34)
dNchdetaDataArr.append(dNchdetaData[:, 3])
dNchdetaDataStatErr.append(dNchdetaData[:, 4])
dNchdetaDataSysErr.append(dNchdetaData[:, 6])
dNchdetaDataCovList.append(computeCovarianceMatrix(dNchdetaData[:, 4],
...
# v2(eta) 0-5%
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=14, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
                                                   vnchdetaData[:, 6]))

# v2(eta) 5-10%
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=51, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
...
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=88, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
...
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=125, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
...
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=162, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
...
vnchdetaData = np.loadtxt(
    path.join(exp_path, "HEPData-ins2679248-v1-Table_1.csv"),
    delimiter=',', skiprows=199, max_rows=30)
vnchdetaDataArr.append(vnchdetaData[:, 3])
vnchdetaDataStatErr.append(vnchdetaData[:, 4])
vnchdetaDataSysErr.append(vnchdetaData[:, 6])
vnchdetaDataCovList.append(computeCovarianceMatrix(vnchdetaData[:, 4],
...
if includev3:
    # v3(eta) 0-5%
    vnchdetaData = np.loadtxt(
        path.join(exp_path, "HEPData-ins2679248-v1-Table_2.csv"),
        delimiter=',', skiprows=14, max_rows=30)
    vnchdetaDataArr.append(vnchdetaData[:, 3])
    vnchdetaDataStatErr.append(vnchdetaData[:, 4])
    vnchdetaDataSysErr.append(vnchdetaData[:, 6])
...
outputDataStatErrList = [dNDataStatErr,
                         pTDataStatErr,
                         vnDataStatErr,
                         pTVarDataStatErr,
                         dNchdetaDataStatErr,
...
outputDataSysErrList = [dNDataSysErr,
                        pTDataSysErr,
                        vnDataSysErr,
                        pTVarDataSysErr,
                        dNchdetaDataSysErr,

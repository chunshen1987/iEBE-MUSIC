...
ipglasma_dict = {
    ...
    'SigmaNN': 68.45,
    'setWSDeformParams': 1,
    'R_WS': 5.420,     # default: 5.42   # 1508.06294 vs. 2108.09578
    'a_WS': 0.570,     # default: 0.57
    'beta2': 0.207,    # default: 0.162
    'beta3': 0.,
    'beta4': -0.003,
    'gamma': 0,        # 0.47
...
music_dict = {
    ...
    'bulk_viscosity_10_max': 0.120,        # the peak value of \zeta/s(T)

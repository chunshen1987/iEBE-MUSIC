...
# 3DMCGlauber model
mcglauber_dict = {
    'database_name': "initialcondition_database/MCGlbAuAu200_sigmaNN_gauss_d0.9_withMultFluct",  # path for initial conditions
}
...
iss_dict = {
    ...
    'number_of_particles_needed': 250000,      # number of hadrons to sample

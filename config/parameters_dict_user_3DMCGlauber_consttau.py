...
mcglauber_dict = {
    'database_name':
        "MCGlb20_sigmaNN_gauss_d0.9",  # path for initial conditions
}
...
music_dict = {
    ...
    'Initial_time_tau_0':
        1.5,  # starting time of the hydrodynamic evolution (fm/c)
    ...
    'X_grid_size_in_fm':
        26.0,  # spatial range along x direction in the transverse plane

...
mcglauber_dict = {
    ...
    'yloss_param_alpha1':
        1.50,  # the small y ~ y^alpha1 for yloss parameterization (>=1.)
    'yloss_param_alpha2':
        0.70,  # the large y ~ y^alpha2 for yloss parameterization [0., 1.]
...
music_dict = {
    ...
    'Grid_size_in_eta':
        64,  # number of the grid points in spatial rapidity direction
    'X_grid_size_in_fm':
        24.0,  # spatial range along x direction in the transverse plane 

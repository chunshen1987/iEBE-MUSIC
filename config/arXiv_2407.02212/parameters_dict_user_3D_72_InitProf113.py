...
music_dict = {
    ...
    'ecm': 72.0,                    # collision energy
    'nucleon_width': 0.5,
    'Eta_plateau_size': 4.5,        # [-Eta_plateau_size/2, Eta_plateau_size/2] for entropy density
    'Eta_fall_off': 0.5,            # Gaussian width fall off for entropy density
    'eta_rhob_0': 2.7,              # peak position of the net baryon density
    'eta_rhob_width_1': 0.2,        # Gaussian width for |eta| > |eta_0|
    'eta_rhob_width_2': 1.9,        # Gaussian width for |eta| < |eta_0|
    'yL_frac': 1.0,

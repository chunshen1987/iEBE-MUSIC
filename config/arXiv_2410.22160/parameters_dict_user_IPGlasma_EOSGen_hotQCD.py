...
control_dict = {
    ...
    'compute_photon_emission': True,   # flag to compute EM radiation from hydrodynamic medium
    'EOSType': 0,
    'EOSId': 0,
    'EOSFileName': "EoS_v0.pkl",
}
...
music_dict = {
    ...
    'quest_revert_strength': 0.5,          # the strength of the viscous regulation
    ...
    'bulk_viscosity_10_max': 0.100,        # the peak value of \zeta/s(T)
    ...
    'Bulk_relaxation_time_type': 2,
    'bulk_relax_time_factor': 5,
...
# photon_emission
photon_dict = {
    'norder': 6,              # calculate photon vn to norder
    'T_dec': 0.120,           # freeze out temperature (GeV)
